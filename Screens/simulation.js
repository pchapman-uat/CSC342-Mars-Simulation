...
function SimulationScreen({navigation}){
    ...
    // Idealy this would be within the same stylesheet as the simStyle but this was not possible as of now
        mercury: [
            simStyle.planet,
             {
            height: 50,
    ...
    return(
        <ScrollView horizontal={true} style={{backgroundColor: new RGB(0,0,0).line()}}>
            ...
            <View style={planetStyles.mercury}>

            
            </View>
            <View style={planetStyles.venus}>

            </View>
            <View style={planetStyles.earth}>

            </View>
            <View style={planetStyles.mars}>

            </View>
            <View style={planetStyles.jupiter}>

            </View>
            <View style={planetStyles.saturn}>

            </View>
            <View style={planetStyles.uranus}>

            </View>
            <View style={planetStyles.neptune}>

            </View>
            <View style={planetStyles.pluto}>
